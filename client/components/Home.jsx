    ...
    return(
        ...
        <div style={this.state.style}>
          ...
          <div style={{textAlign: 'center'}}>
            <h1 style={{color: 'white', fontFamily: 'Montserrat, sans-serif', fontSize: '10rem', fontWeight: '300', position: 'relative', top: '23vh', display: 'inline-block', width: '100vw'}} className='welcome'>Welcome</h1>
            ...
            <Link to='/login'><button className='ui button signin' onClick={this.handleClick} style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '1vw', backgroundColor: 'orange', color: 'white', fontWeight: '100', width: '13vw', height: '6vh', position: 'relative', top: '20vh', display: 'inline-block' }}>SIGN IN</button></Link>
            </div>          
          </IfNotAuthenticated>
          <IfAuthenticated>
